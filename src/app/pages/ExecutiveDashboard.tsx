  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <ActionButton icon={FileCheck} label="Create Quotation" color="purple" onClick={() => alert('Create Quotation coming soon')} />
        <ActionButton icon={QrCode} label="Generate QR Code" color="green" onClick={() => alert('Generate QR Code coming soon')} />
        <ActionButton icon={Send} label="Send Reminder" color="orange" onClick={() => alert('Send Reminder coming soon')} />
        <ActionButton icon={Download} label="VAT Report" color="pink" onClick={() => alert('VAT Report coming soon')} />
      </div>
    </motion.div>
  );
}
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          onClick={() => alert('VAT Report generation coming soon')}
                ...
                <td className="py-4">
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.9 }}
                      onClick={() => alert(`Send invoice ${invoice.id}`)}
                      className="w-8 h-8 rounded-lg bg-gray-800/50 hover:bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white transition-all"
                    >
                      <Send size={16} />
                    </motion.button>
  ...
  return (
    ...
    >
      ...
      <motion.button
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        onClick={() => alert(`${insight.action} - coming soon`)}
    ...
    >
      ...
      <div className="flex gap-2">
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          onClick={() => alert(`${title} generation coming soon`)}
        ...
        <div className="p-8">
          ...
          <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-4">
            ...
            <div className="p-6 bg-gray-800/30 border border-gray-700/50 rounded-2xl">
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => alert('Add Line Item coming soon')}
          ...
          <div className="flex items-center gap-3 mt-6 pt-6 border-t border-gray-800/50">
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => alert('Create & Send coming soon')}
