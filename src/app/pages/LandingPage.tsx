  ...
  const testimonials = [
    {
      ...
      contentAr: 'حوّل ERPX-AI عملياتنا. المساعد الذكي وحده وفّر لنا 30% من التكاليف التشغيلية.',
      avatar: 'AM',
    },
    {
      name: 'Sarah Johnson',
      ...
      content: "Best ERP investment we've made. Financial reporting is now real-time and accurate.",
      contentAr: 'أفضل استثمار في نظام ERP قمنا به. التقارير المالية الآن فورية ودقيقة.',
      avatar: 'SJ',
    },
    {
      ...
      content: "Managing 5 branches became effortless with ERPX-AI's multi-branch capabilities.",
      contentAr: 'إدارة 5 فروع أصبحت سهلة مع قدرات ERPX-AI متعددة الفروع.',
      avatar: 'MR',
    },
  ];
        ...
        >
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-bold mb-6 leading-tight">
              <span className="bg-gradient-to-r from-white via-blue-200 to-cyan-200 bg-clip-text text-transparent">
                {i18n.language === 'ar' ? 'نظام ERP ذكي متكامل' : 'Next Generation'}
              </span>
              <br />
          ...
          >
            <p className="text-gray-500 text-sm mb-6">
              {i18n.language === 'ar'
                ? 'موثوق به من قبل الشركات الرائدة'
            ...
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                <ul className="space-y-4 mb-8">
                  {(i18n.language === 'ar' ? plan.featuresAr : plan.features).map(
                    (feature, idx) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc:
                  i18n.language === 'ar' ? 'أتمتة المهام المتكررة' : 'Automate repetitive tasks',
                stat: 'AI',
              },
              {
                icon: TrendingUp,
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-bold">
                      {i18n.language === 'ar' ? testimonial.nameAr : testimonial.name}
                    </div>
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
                      placeholder={
                        i18n.language === 'ar' ? 'email@example.com' : 'email@example.com'
                      }
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={
                      i18n.language === 'ar' ? 'كيف يمكننا مساعدتك؟' : 'How can we help you?'
                    }
                  />
                </div>
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-semibold">
                        {i18n.language === 'ar' ? 'الرياض، السعودية' : 'Riyadh, Saudi Arabia'}
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-800/50 rounded-lg flex items-center justify-center hover:bg-blue-500/20 transition-all"
                >
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                    {i18n.language === 'ar' ? 'المخزون' : 'Inventory'}
                  </a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                ...
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                    {i18n.language === 'ar' ? 'المالية' : 'Finance'}
                  </a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                    {i18n.language === 'ar' ? 'الموارد البشرية' : 'HR'}
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                    {i18n.language === 'ar' ? 'التوثيق' : 'Documentation'}
                  </a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                ...
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                    {i18n.language === 'ar' ? 'حالات الاستخدام' : 'Use Cases'}
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li>
                  <a href="#" className="hover:text-blue-400 transition-colors">
                    {i18n.language === 'ar' ? 'الترخيص' : 'License'}
                  </a>
                </li>
              </ul>
            </div>
