  ...
  const [chatMessages, setChatMessages] = useState([
    {
      role: 'assistant',
      content:
        "Hello! I'm your AI assistant. I can help you analyze data, generate reports, or optimize your operations. What would you like to know?",
    },
  ]);
    ...
    setTimeout(() => {
      setChatMessages((prev) => [
        ...prev,
        {
          role: 'assistant',
          content:
            "I've analyzed your request. Based on current data patterns, I recommend reviewing the energy consumption report for Floor 2. Would you like me to generate a detailed analysis?",
        },
      ]);
    }, 1200);
  };
        ...
        {quickStats.map((stat, index) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-xs font-semibold ${stat.trend === 'up' ? 'text-green-400' : 'text-red-400'}`}
              >
                {stat.change}
              </span>
            </div>
        ...
        <div className="space-y-8">
          ...
          >
            <div className="space-y-3">
              <AlertCard title="HVAC Malfunction - Floor 2" severity="high" time="2m ago" />
              <AlertCard title="Unusual Energy Spike" severity="medium" time="15m ago" />
              <AlertCard title="Device Offline - Sensor #45" severity="low" time="1h ago" />
            </div>
          </PremiumCard>

          {/* Quick HVAC Control */}
          <PremiumCard title="HVAC Quick Control" subtitle="Adjust temperature by zone" icon={Wind}>
            <div className="space-y-4">
    ...
    >
      ...
      <div className="relative">
        <div className="flex items-start justify-between mb-4">
          <div
            className={`w-14 h-14 bg-gradient-to-br ${gradient} rounded-2xl flex items-center justify-center shadow-lg shadow-${glowColor}-500/20 group-hover:shadow-${glowColor}-500/40 transition-all`}
          >
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span
              className={`text-sm font-bold ${trend === 'up' ? 'text-green-400' : 'text-red-400'}`}
            >
              {change}
            </span>
          </div>
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <div
            className={`w-12 h-12 bg-gradient-to-br ${highlight ? 'from-blue-500 to-purple-500' : 'from-gray-700 to-gray-800'} rounded-2xl flex items-center justify-center shadow-lg`}
          >
