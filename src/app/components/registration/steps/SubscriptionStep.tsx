...
const modules = [
  { key: "finance" as const, label: "Finance & Accounting", description: "Manage financial transactions and reports" },
  { key: "hr" as const, label: "Human Resources", description: "Employee management and payroll" },
  { key: "inventory" as const, label: "Inventory Management", description: "Track stock and warehouses" },
  { key: "pos" as const, label: "Point of Sale", description: "Retail and sales operations" },
  { key: "reports" as const, label: "Advanced Reports", description: "Business intelligence and analytics" },
  { key: "aiAssistant" as const, label: "AI Assistant", description: "Smart automation and insights" },
];
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {errors.plan && (
          <p className="text-red-400 text-sm mt-2">{errors.plan.message}</p>
        )}
      </div>
